...
export const DOC_SECTIONS: DocSection[] = [
      ...
      },
      {
        ...
        articles: [
          ...
          },
          {
            ...
            html: `
            <p>Nach dem ersten erfolgreichen Login (egal ob als Moderator oder Nutzer) werden Sie dazu aufgefordert, Ihr Passwort zu ändern. Dies ist ein wichtiger Schritt, um die Sicherheit Ihres Zugangs zu gewährleisten. Wählen Sie ein sicheres Passwort, das Sie sich gut merken können, aber schwer zu erraten ist. Folgen Sie den Anweisungen auf dem Bildschirm, um Ihr neues Passwort festzulegen.</p>
            <p><span class="hint">Hinweis:</span> Beachten Sie, dass alle anderen CLOCKWORK-Nutzer mit der gleichen Berechtigungsrolle das gleiche Passwort teilen. Daher ist eine teaminterne Absprache zwingend notwendig.</p>
            <p>Nach der Passwortänderung erhalten Sie Zugriff auf die Jahresübersicht (auch Dashboard genannt), die als Startseite von CLOCKWORK dient. Hier können Sie die Dienstpläne für Ihr Team oder Ihren Fachbereich einsehen und verwalten.</p>
          ...
          },
          {
            ...
            <p>Klicken Sie auf die Schaltfläche "Mitarbeiter anlegen & verwalten", um zur Mitarbeiterverwaltung zu gelangen. Hier können Sie alle Mitarbeiter Ihres Teams hinzufügen, bearbeiten oder entfernen.</p>
            <p><span class="hint">Hinweis:</span> Es ist wichtig, dass alle Mitarbeiter korrekt im System erfasst werden, da diese später in den Dienstplänen erscheinen werden.</p>
            <p><span class="hint">Hinweis:</span> Das Angeben eines Enddatums für einen Mitarbeiter ist optional. Wenn kein Enddatum angegeben wird, bleibt der Mitarbeiter im System aktiv, bis er manuell entfernt wird.</p>
            <p>Nachdem Sie alle Mitarbeiter hinzugefügt haben, kehren Sie zum Modpanel zurück und klicken Sie auf "Dienstplan erstellen". Wählen Sie das gewünschte Jahr für den neuen Dienstplan aus, tragen Sie den Urlaubsanspruch und -übertrag von allen Mitarbeitern ein und bestätigen Sie die Erstellung. Der Dienstplan wird nun generiert und ist bereit zur Bearbeitung.</p>
          ...
          },
          {
            ...
            <p>Um einen Eintrag zu machen oder zu ändern, klicken Sie einfach auf das entsprechende Feld im Dienstplan. Wenn dieser markiert ist mit einer Umrandung kann nun z.B. auf den "Urlaub"-Knopf geklickt werden und die ausgewählte Zelle wird als Urlaub hinterlegt. Wie man mehrere Tage auf einmal auswählt und die Tastenkürzel nutzt erfahren Sie in dem <a href="/docs/grundlagen-der-nutzung/dienstplaene-auswaehlen-und-navigieren" class="emp">Hauptdokument</a>.</p>
            `
          }
        ]
      }
        ...
        articles: [
          {
            ...
            <p>Der neueste Dienstplan wird immer ganz oben links angezeigt, gefolgt von den vorherigen Jahren in absteigender Reihenfolge. Moderatoren haben zusätzlich die Möglichkeit, in der Jahresübersicht die spezifischen Pläne zu bearbeiten.</p>
          `
          },
          {
            id: "monatsuebersicht",
          ...
          },
          {
            ...
            title: "Planlogs",
            html: `
            <p>Die Planlogs dienen der vollständigen Nachverfolgung aller Änderungen im Dienstplan. Hierbei werden Eintragungen, Löschungen und auch Änderungen an Plannotizen protokolliert.</p>
            ...
            <p>Logs können nach Aktionstyp und Mitarbeiter gefiltert werden, um schnelle Übersichten zu ermöglichen.</p>
            <p><span class="hint">Hinweis:</span> Um zurück zum Planviewer zu gelangen, kann die Jahreszahl im Titel angeklickt werden.</p>
          `
          }
        ]
      },
      {
        ...
        articles: [
          ...
          },
          {
            ...
            <p><span class="hint">Hinweis:</span> Patch-Updates (z.B. Version x.x.1) werden nicht im Changelog eingetragen, da es sich bei diesen Updates eher um kleine/unauffällige Verbesserungen und Fehlerbehebungen handelt.</p>
            `
          },
          {
      ...
      },
      {
        ...
        articles: [
          ...
          },
          {
            ...
            <ul>
            <li>Solide: Ein klarer und einfacher Stil ohne Texturen und ohne durchsichtige Elemente. Bietet eine saubere und übersichtliche Anzeige und erleichtert zusätzlich die Lesbarkeit. Außerdem können hier die verschiedenen visuellen Ebenen am einfachsten voneinander getrennt werden.</li>
          ...
          },
          {
            ...
            html: `
            <p>Die Kontureneinstellung ermöglicht es Ihnen, die Sichtbarkeit der Umrandungen in CLOCKWORK anzupassen. Sie können wählen, ob Konturen angezeigt werden sollen oder nicht. Diese Einstellung beeinflusst die Trennung von verschiedenen visuellen Ebenen.</p>
            <p>Wenn Konturen aktiviert sind, werden die verschiedenen Bereiche und Elemente klar voneinander abgegrenzt, was die Übersichtlichkeit erhöht. Dies ist besonders hilfreich, wenn viele Informationen und Ebenen auf einmal angezeigt werden.</p>
            `
          },
          {
            id: "empfehlung",
  ...
  },
  {
    ...
    pages: [
        ...
        articles: [
          {
            ...
            html: `
              ...
              <p><span class="hint">Hinweis:</span> Der Nutzer ist ein zentraler Zugang eines Teams für alle Mitarbeiter, die das System nutzen. Es gibt keine individuellen Anmeldedaten, da jeder User die gleichen Berechtigungen hat. Somit teilen sich alle Nutzer beim Nutzer-Zugang den gleichen Nutzernamen und das gleiche Passwort.</p>
            `
          },
          {
            id: "rolle-mod",
            ...
            html: `
              ...
              <p><span class="hint">Hinweis:</span> Der Mod-Zugang ist (wie der Nutzer-Zugang) ein zentraler Zugang eines Teams für alle Moderatoren. Es gibt keine individuellen Anmeldedaten, da jeder Moderator die gleichen Berechtigungen hat. Wie bei den Nutzer-Zugängen auch teilen sich alle Moderatoren eines Teams den gleichen Nutzernamen und das gleiche Passwort.</p>
              `
          },
          {
            id: "rolle-admin",
            ...
            html: `
              <p>Die Rolle "Administrator" hat die höchsten Rechte in CLOCKWORK. Administratoren können alle Funktionen nutzen, einschließlich der Verwaltung von Teams, Nutzern und Moderatoren sowie der Systemkonfiguration.</p>
      ...
      },
      {
        ...
        articles: [
          {
            id: "was-passiert-bei-der-passwort-zuruecksetzung",
            ...
            <p><span class="hint">Hinweis:</span> Es ist wichtig, dass bei der Wahl eines neuen Passwortes darauf geachtet wird, dass alle CLOCKWORK-Nutzer eines Teams oder Fachbereiches sich nun das gleiche Passwort merken müssen. Daher sollte das Passwort sicher, aber auch für alle Teammitglieder leicht merkbar sein.</p>
            <p><span class="hint">Hinweis:</span> Mitglieder aus anderen Teams oder Fachbereichen sind von dieser Passwortänderung nicht betroffen und behalten ihre eigenen Zugangsdaten.</p>
            <p><span class="hint">Hinweis:</span> Administratoren und Moderatoren können nicht einsehen, welches Passwort aktuell gesetzt ist. Dies dient dem Schutz der Zugangsdaten und verhindert unbefugten Zugriff.</p>
            `
          },
          {
            id: "warum-gibt-es-keine-individuellen-zugaenge",
        ...
        articles: [
          {
            ...
            html: `
              ...
              <p>Alle eingetragenen Informationen können jederzeit zu einem späteren Zeitpunkt bearbeitet werden. Gehen Sie dafür einfach wieder in den "Mitarbeiter bearbeiten & anlegen" Bereich im Modpanel, nehmen Sie die gewünschten Änderungen vor und speichern Sie diese.</p>
              <p><span class="hint">Hinweis:</span> In dem unten stehenden Artikel "Dienstpläne bearbeiten" wird beschrieben, wie Sie die Aktualisierung an dem Mitarbeiter auch im Dienstplan anzeigen lassen können (also z.B. das nachträgliche Hinzufügen eines Mitarbeiters und Änderungen am Start- und Enddatum)</p>
              `
          },
          {
            ...
            html: `
            <p>Wenn die Mitarbeiterverwaltung abgeschlossen ist und die Liste der Mitarbeiter aktuell ist, können Dienstpläne erstellt werden.</p>
            ...
            <p>Nachdem alle erforderlichen Informationen eingegeben wurden, klicken Sie auf "Dienstplan erstellen". Das System generiert daraufhin den Dienstplan für das ausgewählte Jahr, der nun in der Jahresübersicht verfügbar ist.</p>
            <p>Alle CLOCKWORK-Nutzer aus Ihrem Team sehen nun den erstellten Plan in ihrer Jahresübersicht und können Einträge vornehmen.</p>
            `
          },
          {
          ...
          },
          {
            ...
            <p>Um das Passwort zurückzusetzen, navigieren Sie zum Modpanel und scrollen Sie unten in den Bereich "Systemnutzer verwalten".</p>
            <p><span class="hint">Hinweis:</span> Beim Bestätigen des Zurücksetzens gilt nun für alle Nutzer des Teams das neue Passwort. Dieses muss direkt beim ersten Login nach der Zurücksetzung geändert werden.</p>
            `
          }
        ]
      },
        ...
        articles: [
          {
            ...
            html: `
            <p>Administratoren haben die Berechtigung, neue Teams zu erstellen. Um diese zu erstellen, navigieren Sie zum Adminpanel über die Kopfzeile. Im Adminpanel finden Sie den Bereich "Neuen Fachbereich erstellen".</p>
            <p>Geben Sie den Namen des neuen Teams in das dafür vorgesehene Eingabefeld ein. Standardmäßig folgen die angelegten Nutzernamen diesem Format:</p>
            <ul>
            <li>"user-[teamname]" für den Nutzer-Zugang des Teams</li>
            <li>"mod-[teamname]" für den Moderator-Zugang des Teams</li>
            </ul>
            <p>Falls gewünscht, können die Standard-Nutzernamen angepasst werden, indem auf den Text "Optionale Benutzernamen festlegen" geklickt wird. Dadurch öffnen sich Eingabefelder, wo die Nutzernamen entsprechend eingetragen werden können.</p>
            <p><span class="hint">Hinweis:</span> Teamnamen sowie die zugehörigen Nutzernamen können nach Erstellung nicht mehr geändert werden.</p>
            <p>Nachdem der Name des Teams und die gewünschten Nutzernamen eingegeben haben, muss auf den Knopf "Fachbereich & Nutzer anlegen" geklickt werden. Das System erstellt daraufhin den neuen Team zusammen mit den zugehörigen Nutzer- und Moderator-Zugängen.</p>
            <p>Die neuen Teams sind nun im System verfügbar, und die zugehörigen Nutzer können sich mit den bereitgestellten Zugangsdaten anmelden.</p>
            <p>Unter dem genannten Bereich befindet sich eine Liste aller bereits angelegten Teams und Fachbereiche. Diese Liste zeigt die Namen der Teams sowie die zugehörigen Nutzernamen für den Nutzer- und Moderator-Zugang an.</p>
            `
          },
          {
            ...
            html: `
            <p>Administratoren haben ebenfalls die Berechtigung, erstellte Teams zu löschen.</p>
            <p><span class="hint">Hinweis:</span> Damit ein Team gelöscht werden kann, müssen alle Mitarbeiter des Teams gelöscht werden und es dürfen keine Dienstpläne für das Team existieren. <span class="emp">Dies wird jedoch in einem späteren Update geändert.</span></p>
            ...
            <p>Sobald ein Fachbereich/Team gelöscht wurde, besteht kein Eintrag mehr in der Datenbank, also können sich die Nutzer des Teams sich nicht mehr anmelden (da auch die Benutzer gelöscht werden) und Administratoren können sich nicht über den Impersonationsmodus einschalten.</p>
            `
          },
          {
            ...
            html: `
            <p>Der Impersonationsmodus ermöglicht es Administratoren, sich temporär als ein Moderator eines Fachbereichs/Teams anzumelden. Dies ist besonders nützlich für Support- und Wartungszwecke, da Administratoren so Probleme aus der Perspektive des betroffenen Nutzers nachvollziehen können.</p>
          ...
          },
          {
            ...
            html: `
            <p>Genauso wie Moderatoren die Nutzer-Passwörter zurücksetzen können, haben Administratoren die Berechtigung, zusätzlich auch noch die Passwörter der Moderator-Zugänge aller Fachbereiche/Teams zurückzusetzen. Dies ist besonders nützlich, wenn ein Moderator sein Passwort vergessen hat oder dieses aus Sicherheitsgründen geändert werden muss.</p>
            <p>Um das Passwort eines Moderators und/oder Nutzers zurückzusetzen, navigieren Sie zum Modpanel und begeben Sie sich in den Bereich "Systemnutzer verwalten". Dort befinden sich zwei Knöpfe, mit denen entweder das Nutzer und/oder das Moderatorpasswort zurückgesetzt werden kann.</p>
            <p><span class="hint">Hinweis:</span> Beim Bestätigen des Zurücksetzens gilt nun für alle Moderatoren und/oder Nutzer des Teams das neue Passwort. Dieses muss direkt beim ersten Login nach der Zurücksetzung geändert werden.</p>
            `
          },
          {
            ...
            html: `
            <p>Um als Administrator das Feedback der Systemnutzer auszulesen, navigieren Sie unten in der Fußzeile auf den Knopf "Feedback". Dadurch gelangen Sie zur Feedback-Übersichtsseite, auf der alle eingereichten Feedback-Einträge angezeigt werden.</p>
            <p>Auf der Feedback-Übersichtsseite sehen Sie eine Liste aller Feedback-Einträge. Jeder Eintrag enthält Informationen wie das Datum und Uhrzeit der Einreichung, einer Kategorie, den Nutzernamen, die Version, mit der das Feedback abgeschickt wurde und dem eigentlichen Feedback-Text.</p>
            <p>Jedes Feedback-Element hat außerdem einen Status-Indikator, der den aktuellen Bearbeitungsstatus des Feedbacks anzeigt. Die möglichen Status sind "neu", "gelesen" und "bearbeitet". Der Status kann natürlich geändert werden und nach dem Status kann man filtern. Feedback-Einträge können auch gelöscht werden.</p>
            `
          }
        ]
      }
  ...
  {
    id: "haeufige-probleme-faq-und-sonstiges",
    title: "Häufige Probleme, FAQ & Sonstiges",
    description: "Antworten auf typische Fragen zu Anmeldung, Mitarbeitern, Status und Dienstplänen & co.",
    ...
    pages: [
        ...
        articles: [
          {
            ...
            <ul>
              ...
              <li>Sich merken welcher Fehler genau gefunden wurde und wie dieser ausgelöst wurde (ist es ein visueller Fehler, Rechtschreibfehler, Logikfehler, etc).</li>
          ...
          {
            id: "overlays-werden-nicht-angezeigt",
            title: "Overlays werden nicht angezeigt - wie behebe ich das?",
            html: `
            <p>Wenn Systemoverlays (z.B. von der Passworteingabe, dem Feedbackformular, den Anzeigeeinstellungen, etc.) nicht korrekt oder garnicht angezeigt werden, liegt es an einem visuellen Fehler im Browser.</p>
            <p>Um diesen Fehler zu beheben muss einfach CLOCKWORK neugeladen werden (z.B. über die F5-Taste). Dadurch sollte der Fehler nicht mehr auftreten.</p>
            `
          },
          {
          ...
          <ul>
            <li>Richtigen Nutzernamen verwenden: Achten Sie darauf, dass Sie den korrekten Team-Nutzernamen eingeben (z.B. user-it oder mod-it).</li>
          ...
          <ul>
            ...
            <li>Impersonation (nur Admins): Wenn Sie als Administrator angemeldet sind, stellen Sie sicher, dass im Modpanel der korrekte Fachbereich ausgewählt ist.</li>
          </ul>
      ...
      },
      {
        ...
        articles: [
          ...
          <p><span class="hint">Hinweis:</span> In vielen Fällen reicht es aus, den betroffenen Dienstplan in der Jahresübersicht zu bearbeiten und den Mitarbeiter über den "Mitarbeiter-Sync" in den Plan aufzunehmen.</p>
          `
          },
          {
          ...
          <p><span class="hint">Hinweis:</span> Der Mitarbeiter-Sync legt keine Urlaubsansprüche oder andere Werte automatisch fest, diese müssen weiterhin manuell geprüft und eingetragen werden.</p>
          `
          },
          {
          ...
          <p><span class="hint">Hinweis:</span> Der Datum-Sync verändert keine bestehenden Urlaubs- oder Status-Einträge innerhalb des gültigen Zeitraums, sondern passt nur den Zeitraum an, in dem der Mitarbeiter im Plan geführt wird.</p>
          `
          }
        ]
      },
      {
        ...
        articles: [
          ...
          <p>Über die Logs (Knopf "Logs anzeigen" im Planviewer) können Sie nachvollziehen, welche Änderungen an einem Dienstplan vorgenommen wurden. Dort sehen Sie unter anderem Datum, Uhrzeit, Zeitraum und Art der Änderung. Auf diese Weise können Sie Änderungen transparent nachverfolgen und bei Bedarf intern klären.</p>
          `
          }
        ]
      },
      {
        id: "systemaufbau-von-clockwork",
        title: "Systemaufbau von CLOCKWORK",
        ...
        articles: [
          {
            ...
            html: `
            <p>CLOCKWORK wurde konzipiert als abteilungsbezogenes System (sogenannte "scopes"), das bedeutet, dass es in verschiedene Bereiche unterteilt ist. Jeder Scope repräsentiert eine Abteilung oder ein Team innerhalb der Stadtverwaltung.</p>
          ...
          },
          {
            ...
            <p>Insgesamt bietet der technische Aufbau von CLOCKWORK eine robuste und zuverlässige Plattform für die Anforderungen der Stadtverwaltung.</p>
            `
          }
        ]
      }
